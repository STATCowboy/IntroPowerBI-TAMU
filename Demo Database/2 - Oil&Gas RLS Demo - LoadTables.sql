...
-- 10/28/2015
-- 
-- Updated 01/10/2022 - Added Decline Curves logic for Daily Production
-- 
...
DECLARE
  ...
  @val float,
  @lambda float =  -1 * (RAND()*(.001-.0005)+.0005),
  @status varchar(64);
...
BEGIN
  ...
  BEGIN
	...
	SET @val = CAST(RAND()*(500-100)+100 AS FLOAT)
